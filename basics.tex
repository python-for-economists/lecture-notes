...
If the \texttt{discountPrice} function sits in the middle of a payment system of some company, and at some point it is invoked with a discount that is greater than 100$\backslash$%, then something clearly went wrong somewhere.
We found a bug!
